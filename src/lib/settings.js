...
export const NAV = [
  ...
  /* Блог живе поза застосунком (публічний /blog, без Layout), але
     посилання на нього зручно тримати тут же — окремою групою, а не
     вкраденим пунктом у «Data», бо це інша частина сайту, не розділ
     журналу. У демо цю групу навмисно не показуємо: /blog там ніхто
