...
/* Скільки триває безкоштовний період і скільки коштує привʼязка.
   ...
   Долар, а не нуль. Нуль виглядає добріше, але нічого не доводить:
   картка з нульовим балансом чи з забороною інтернет-платежів пройде
   верифікацію і відвалиться рівно через два тижні, коли людина вже
   звикла до продукту. Долар — найдешевша перевірка, що картка справді
   робоча. */
