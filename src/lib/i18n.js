  ...
  faq: {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { q: 'Do I have to pay to start?', a: 'No. The plan, the journal, analytics, diagnostics, checklists and your trading system stay free with no time limit. Pro adds MetaTrader auto-import, the Telegram bot, multiple accounts, backtesting and the AI coach for $15 a month, or $12 a month billed yearly ($144).' },
  ...
  faq: {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { q: 'Треба платити, щоб почати?', a: 'Ні. План, журнал, аналітика, діагностика, чеклісти й торгова система лишаються безкоштовними без обмеження в часі. Pro додає автоімпорт з MetaTrader, Telegram-бота, кілька рахунків, бектести й AI-коуча — $15 на місяць або $12 на місяць при оплаті за рік ($144).' },
  ...
  faq: {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { q: 'Надо платить, чтобы начать?', a: 'Нет. План, журнал, аналитика, диагностика, чеклисты и торговая система остаются бесплатными без ограничения по времени. Pro добавляет автоимпорт из MetaTrader, Telegram-бота, несколько счетов, бэктесты и AI-коуча — $15 в месяц или $12 в месяц при оплате за год ($144).' },
