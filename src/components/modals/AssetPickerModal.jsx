...
/* Своєї копії знака активу тут більше немає.

   Вона була майже такою ж, як у components/ui/AssetIcon — і саме
   «майже» коштувало дорого: обидві правились окремо, і в списку
   вибору прапори виглядали інакше, ніж у тому ж рядку журналу.
   Один компонент на весь застосунок.

   Реекспорт лишаємо: на цю назву звідси вже посилаються. Імпорт
