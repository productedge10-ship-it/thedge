      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full bg-[var(--edge-bg)]/95 backdrop-blur-2xl border border-[var(--edge-hair-strong)] rounded-xl shadow-[0_20px_50px_var(--edge-panel-glow,rgba(0,0,0,0.5))] z-[100] py-1.5 overflow-hidden"
          >
                ...
                <div
                  ...
                  className={`px-4 py-2.5 text-xs font-bold tracking-wide cursor-pointer transition-colors ${
                    value === option 
                      ...
                      : 'text-[var(--edge-text3)] hover:text-[var(--edge-text)] hover:bg-[var(--edge-hair)] border-l-2 border-transparent'
                  }`}
                >
