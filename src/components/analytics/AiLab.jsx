...
export default function AiLab({ s }) {
  ...
  return (
    <div
      ...
      /* Тла в розділу немає взагалі — крізь нього видно фон Layout.

         Раніше тут лежав власний #050508. Але сайдбар — панель, що
         плаває з полем у 16 пікселів навколо, і в це поле видно фон
         сторінки. Щойно розділ малював свій непрозорий прямокутник,
         межа між ним і полем сайдбара ставала смугою: два різні
         чорні поруч. Прозоре тло цю межу прибирає, бо прибирає сам
         прямокутник — лишається атмосфера (крапки, світіння, велике
         слово), яка лежить шарами поверх спільного фону. */
      style={{
